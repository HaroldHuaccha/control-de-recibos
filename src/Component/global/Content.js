...
class Content extends Component {
    ...
    mostrarData() {
        ...
        if (this.state.estado) {
            ...
            switch (this.state.operacion) {
                case "error": contenedor = (<div className="alert alert-info text-center">{this.state.mensaje}</div>); break;
    ...
    handleSearchClick(e) {       
        ...
        // console.log(url);
        if (this.state.nombre_apellido === "" && this.state.concepto === "" && this.state.voucher === "" && //this.state.recibo === ""
            ...
            fetch(url, {
                ...
                .catch(err => {
                    ...
                    icon: 'error',
                    title: 'Incorrecto',
                    text: 'El dato que ha ingresado es incorrecto',
                    })
                    // this.setState({
                    //     estado: true,
                    //     operacion: "error",
